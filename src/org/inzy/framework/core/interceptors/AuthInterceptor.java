package org.inzy.framework.core.interceptors;
...
import org.inzy.framework.core.extend.hqlsearch.SysContextSqlConvert;
...
import org.inzy.framework.web.system.manager.ClientManager;
import org.inzy.framework.web.system.pojo.base.Client;
import org.inzy.framework.web.system.pojo.base.TSDataRule;
			...
			if (client != null && client.getUser()!=null ) {
				...
				if(!oConvertUtils.isEmpty(functionId)){
					...
					for (String dataRuleId : dataruleCodes) {
					 ...
					 InzyDataAutorUtils.installDataSearchConditon(request, MENU_DATA_AUTHOR_RULES);//菜单数据规则集合
					 InzyDataAutorUtils.installDataSearchConditon(request, MENU_DATA_AUTHOR_RULE_SQL);//菜单数据规则sql
