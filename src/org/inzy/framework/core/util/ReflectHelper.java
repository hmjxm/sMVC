	...
	public void initMethods() {
		...
		for (int i = 0; i < methods.length; ++i) {
			...
			if (Pattern.matches(gs, methodName)) {
				...
				// org.inzy.framework.core.util.LogUtil.info(methodName + " 不是getter,setter方法！");
			}
		}
	}
	...
	public boolean setMethodValue(String property,Object object) {
		...
		if (m != null) {
			try {
				...
				org.inzy.framework.core.util.LogUtil.info("invoke getter on " + property + " error: " + ex.toString());
				return false;
			}
		}
		return false;
