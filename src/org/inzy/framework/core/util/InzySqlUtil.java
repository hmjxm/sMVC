...
import org.inzy.framework.core.def.ConstantsDefs;
...
public class InzySqlUtil {
	...
	private static String getFlieTxt(String fileUrl) {
		org.inzy.framework.core.util.LogUtil.info("---------------------------------------sql 路径 :"+fileUrl);
		String sql = null;
		try {
	...
	public static String getMethodSqlLogic(String methodUrl){
		...
		String projectPath = getAppPath(InzySqlUtil.class);
		sqlurl = projectPath + SUFFIX_X+sqlurl;
		org.inzy.framework.core.util.LogUtil.info(sqlurl);
...
//		返回读取指定资源的输入流   
        InputStream is = InzySqlUtil.class.getResourceAsStream(sqlurl);    
...
//		org.inzy.framework.core.util.LogUtil.info(projectPath);
//		String projectPath =  request.getSession().getServletContext().getRealPath("/");
	...
	public static String getAppPath(Class cls) {
		...
		org.inzy.framework.core.util.LogUtil.info("realPath----->"+realPath);
		return realPath;
	}
	...
	public static void main(String[] args) {
		//org.inzy.framework.core.util.LogUtil.info(getAppPath(InzySqlUtil.class));
		org.inzy.framework.core.util.LogUtil.info(getCountSqlBySql("SELECT * 	from INZY_DICT_PARAM WHERE 1=1"));
	}
