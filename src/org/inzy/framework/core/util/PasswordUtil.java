...
public class PasswordUtil {
	...
	public static void main(String[] args) {
		...
		org.inzy.framework.core.util.LogUtil.info("明文:" + str);
		org.inzy.framework.core.util.LogUtil.info("密码:" + password);

		try {
			byte[] salt = PasswordUtil.getStaticSalt();
			String ciphertext = PasswordUtil.encrypt(str, password, salt);
			org.inzy.framework.core.util.LogUtil.info("密文:" + ciphertext);
			String plaintext = PasswordUtil.decrypt(ciphertext, password, salt);
			org.inzy.framework.core.util.LogUtil.info("明文:" + plaintext);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
