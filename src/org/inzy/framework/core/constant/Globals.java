package org.inzy.framework.core.constant;
...
public final class Globals {
	...
	public static Short Log_Leavel_ERROR=3;
	 ...
	 static{
		 String button_authority_inzy = ResourceUtil.getSessionattachmenttitle("button.authority.inzy");
		 if("true".equals(button_authority_inzy)){
