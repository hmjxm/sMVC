package org.inzy.framework.core.extend.hqlsearch;
...
import org.inzy.framework.core.annotation.query.QueryTimeFormat;
import org.inzy.framework.core.common.hibernate.qbc.CriteriaQuery;
import org.inzy.framework.core.constant.Globals;
import org.inzy.framework.core.extend.hqlsearch.parse.ObjectParseUtil;
import org.inzy.framework.core.extend.hqlsearch.parse.PageValueConvertRuleEnum;
import org.inzy.framework.core.extend.hqlsearch.parse.vo.HqlRuleEnum;
...
public class HqlGenerateUtil {
	...
	private static Map<String, TSDataRule> getRuleMap() {
		...
		List<TSDataRule> list =InzyDataAutorUtils.loadDataSearchConditonSQL(); //(List<TSDataRule>) ContextHolderUtils
