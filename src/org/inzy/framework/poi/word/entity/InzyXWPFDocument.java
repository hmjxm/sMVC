 ...
 public class InzyXWPFDocument
   extends XWPFDocument
 {
   public InzyXWPFDocument() {}
   
   public InzyXWPFDocument(OPCPackage opcPackage)
     throws Exception
   {
     super(opcPackage);
   }
   
   public InzyXWPFDocument(InputStream in) throws Exception {
     super(in);
   }
