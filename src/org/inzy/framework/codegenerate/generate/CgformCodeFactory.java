...
public class CgformCodeFactory extends BaseCodeFactory {
	...
	public String getCodePath(String type, String entityPackage,
		...
		if ((this.packageStyle != null)
				&& (CodeResourceUtil.PACKAGE_SERVICE_STYLE
						.equals(this.packageStyle))) {
			codePath = getCodePathServiceStyle(path, type, entityPackage,
					entityName);
		} else {
			codePath = getCodePathProjectStyle(path, type, entityPackage,
					entityName);
		}
		return codePath;
	}
