...
import org.inzy.framework.core.util.ImportUtil;
import org.inzy.framework.core.util.JSONHelper;
import org.inzy.framework.core.util.MyClassLoader;
...
public class CommonController extends BaseController {
	...
	public ModelAndView openViewFile(HttpServletRequest request) {
		...
		String subclassname = oConvertUtils.getString(request.getParameter("subclassname"), "org.inzy.framework.web.system.pojo.base.TSAttachment");
	...
	public void viewFile(HttpServletRequest request, HttpServletResponse response) {
		...
		String subclassname = oConvertUtils.getString(request.getParameter("subclassname"), "com.inzy.base.pojo.TSAttachment");
		Class fileClass = MyClassLoader.getClassByScn(subclassname);// 附件的实际类
		Object fileobj = systemService.getEntity(fileClass, fileid);
		ReflectHelper reflectHelper = new ReflectHelper(fileobj);
