...
import org.inzy.framework.core.common.model.json.ComboBox;
import org.inzy.framework.core.common.model.json.DataGrid;
import org.inzy.framework.core.common.model.json.ValidForm;
...
import org.inzy.framework.tag.vo.datatable.DataTables;
...
//			}
	...
	public void datagrid(TSUser user,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
        ...
        //查询条件组装器
        org.inzy.framework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, user);
...
//				}
	...
	public String changeStyle(HttpServletRequest request) {
		...
		for (Cookie cookie : cookies) {
			...
			if(cookie.getName().equalsIgnoreCase("INZYINDEXSTYLE")){
	...
	public AjaxJson saveStyle(HttpServletRequest request,HttpServletResponse response) {
		...
		if(user!=null){
			...
			if(StringUtils.isNotEmpty(indexStyle)){
				Cookie cookie = new Cookie("INZYINDEXSTYLE", indexStyle);
				//设置cookie有效期为一个月
