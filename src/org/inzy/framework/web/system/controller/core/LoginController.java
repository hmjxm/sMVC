...
import org.inzy.framework.core.extend.datasource.DataSourceContextHolder;
import org.inzy.framework.core.extend.datasource.DataSourceType;
...
public class LoginController extends BaseController{
	...
	public AjaxJson checkuser(TSUser user, HttpServletRequest req) {
		...
		DataSourceContextHolder
				.setDataSourceType(DataSourceType.dataSource_inzy);
	...
	public String login(ModelMap modelMap,HttpServletRequest request) {
		DataSourceContextHolder.setDataSourceType(DataSourceType.dataSource_inzy);
