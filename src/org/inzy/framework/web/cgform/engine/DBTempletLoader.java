...
import org.inzy.framework.web.cgform.common.FormHtmlUtil;
...
public class DBTempletLoader implements TemplateLoader {
	...
	public static final String TEMPLET = "org/inzy/framework/web/cgform/engine/jform.ftl";
	public static final String TEMPLET_ONE_MANY = "org/inzy/framework/web/cgform/engine/jformunion.ftl";
	//生成输入框匹配内容
    ...
    public Object findTemplateSource(String name) throws IOException {
		...
		//update by Robin postgreSQL 修正大小写的问题 2013-03-13
    	org.inzy.framework.core.util.LogUtil.info("table name----------->"+name);
    ...
    private Object getObject(String name) throws IOException {
    	...
    	if(name.lastIndexOf(".ftl")==-1){//判断是否为include的模板
            ...
            if(cgformFtlEntity!=null){
	    		...
	    		org.inzy.framework.core.util.LogUtil.info(content);
...
//				path = path.substring(6, path.indexOf("WEB-INF") + 8)+"classes/inzy/cgform/engine/";//window 
//			}else{
//				path = path.substring(5, path.indexOf("WEB-INF") + 8)+"classes/inzy/cgform/engine/";//linux
//			}
//			try {
...
//				e.printStackTrace();
//			}
//			org.inzy.framework.core.util.LogUtil.info("current path :" + path);
//		}
