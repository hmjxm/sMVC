package org.inzy.framework.web.cgform.service.impl.autolist;
...
import org.inzy.framework.web.cgform.common.CommUtils;
...
import org.inzy.framework.web.cgform.service.build.DataBaseService;
...
public class CgTableServiceImpl extends CommonServiceImpl implements CgTableServiceI {
	...
	public List<Map<String, Object>> querySingle(String table, String field, Map params,
		...
		List<Map<String, Object>> result = commonService.findForJdbc(sqlB
				.toString(), page, rows);
		return result;
	}
		...
		try{
			...
			if(data!=null){
			    ...
			    while(it.hasNext()){
			        ...
			        org.inzy.framework.core.util.LogUtil.info("name:"+ok.toString()+";value:"+ov.toString());
			    }
	...
	private void dealQuerySql(String table, String field, Map params,StringBuilder sqlB){
		...
		Object dataRuleSql = InzyDataAutorUtils.loadDataSearchConditonSQLString();//ContextHolderUtils.getRequest().getAttribute(Globals.MENU_DATA_AUTHOR_RULE_SQL);
