...
import org.inzy.framework.web.cgform.exception.DBException;
...
public class DbTableProcess {
	...
	public static void createOrDropTable(CgFormHeadEntity table, Session session) throws IOException, TemplateException, HibernateException, SQLException, DBException  {
		Template t;
		t = getConfig("/org/inzy/framework/web/cgform/engine/hibernate").getTemplate("tableTemplate.ftl");
...
//       .setProperty("hibernate.connection.username",propertiesUtil.readProperty("jdbc.username.inzy"))
//       .setProperty("hibernate.connection.password",propertiesUtil.readProperty("jdbc.password.inzy"))  
//       .setProperty("hibernate.dialect",propertiesUtil.readProperty("hibernate.dialect"))
//       .setProperty("hibernate.connection.url",propertiesUtil.readProperty("jdbc.url.inzy"))
