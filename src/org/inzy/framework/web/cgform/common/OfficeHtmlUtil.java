package org.inzy.framework.web.cgform.common;
...
public class OfficeHtmlUtil {
	...
	public void excelToHtml(String xlsfile, String htmlfile) {
		...
		try {
			...
			org.inzy.framework.core.util.LogUtil.info("wordtohtml转换成功");
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			app.invoke("Quit", new Variant[] {});
...
//		wordtohtml.wordToHtml("D://inzy//qjd.doc", "D://inzy//test.html");
		wordtohtml.WordConverterHtml("D://inzy//qjd.doc", "D://inzy//test.html");
		String htmlStr = wordtohtml.getInfo("D://inzy//test.html");
		htmlStr = wordtohtml.doPoiHtml(htmlStr);
		wordtohtml.stringToFile(htmlStr,"D://inzy//tt.html");
	}catch (IOException e4) {}
