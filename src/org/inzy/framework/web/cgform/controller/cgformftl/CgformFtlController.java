package org.inzy.framework.web.cgform.controller.cgformftl;
...
import org.inzy.framework.core.util.FileUtils;
import org.inzy.framework.core.util.LogUtil;
...
import org.inzy.framework.web.cgform.common.OfficeHtmlUtil;
...
public class CgformFtlController extends BaseController {
	...
	public ModelAndView ckeditor(HttpServletRequest request, String id) {
		...
		return new ModelAndView("inzy/cgform/cgformftl/ckeditor");
	}
	...
	public ModelAndView cgformFtl(HttpServletRequest request) {
		...
		return new ModelAndView("inzy/cgform/cgformftl/cgformFtlList");
	}
	...
	public ModelAndView addorupdate(CgformFtlEntity cgformFtl,
		...
		return new ModelAndView("inzy/cgform/cgformftl/cgformFtl");
	}
	...
	public ModelAndView cgformFtl2(HttpServletRequest request) {
		String formid = request.getParameter("formid");
		request.setAttribute("formid", formid);
		return new ModelAndView("inzy/cgform/cgformftl/cgformFtlList2");
	}
	...
	public ModelAndView addorupdate2(CgformFtlEntity cgformFtl,
		...
		req.setAttribute("cgformFtlPage", cgformFtl);
		return new ModelAndView("inzy/cgform/cgformftl/cgformFtlEditor");
	}
