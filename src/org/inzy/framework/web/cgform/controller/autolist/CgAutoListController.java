package org.inzy.framework.web.cgform.controller.autolist;
...
import org.inzy.framework.core.util.InzyDataAutorUtils;
...
import org.inzy.framework.web.cgform.service.autolist.CgTableServiceI;
import org.inzy.framework.web.cgform.service.autolist.ConfigServiceI;
import org.inzy.framework.web.cgform.service.config.CgFormFieldServiceI;
import org.inzy.framework.web.cgform.util.QueryParamUtil;
import org.inzy.framework.web.system.pojo.base.DictEntity;
...
public class CgAutoListController extends BaseController{
	...
	public void list(String id, HttpServletRequest request,
		...
		String html = viewEngine.parseTemplate("/org/inzy/framework/web/cgform/engine/autolist/autolist.ftl", paras);
		try {
	...
	public void datagrid(String configId,String page,String field,String rows,String sort,String order, HttpServletRequest request,
		...
		Object dataRuleSql =InzyDataAutorUtils.loadDataSearchConditonSQLString(); //request.getAttribute(Globals.MENU_DATA_AUTHOR_RULE_SQL);
		long start = System.currentTimeMillis();
		//step.1 获取动态配置
