...
import org.inzy.framework.web.demo.service.test.TFinanceServiceI;
import org.inzy.framework.web.system.pojo.base.TSDocument;
...
public class TFinanceController extends BaseController {
	...
	public ModelAndView tFinance(HttpServletRequest request) {
		return new ModelAndView("inzy/demo/test/tFinanceList");
	}
	...
	public void datagrid(TFinanceEntity tFinance,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		org.inzy.framework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tFinance, request.getParameterMap());
	...
	public ModelAndView addorupdate(TFinanceEntity tFinance, HttpServletRequest req) {
		...
		return new ModelAndView("inzy/demo/test/tFinance");
	}
}
