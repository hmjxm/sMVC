...
import org.inzy.framework.web.system.pojo.base.TSDemo;
import org.inzy.framework.web.system.pojo.base.TSFunction;
...
public class DemoController extends BaseController {
	...
	public ModelAndView aorudemo(TSDemo demo, HttpServletRequest request) {
		...
		if (type.equals("table")) {
			return new ModelAndView("inzy/demo/base/tabledemo");
		} else {
			return new ModelAndView("inzy/demo/base/demo");
		}
	...
	public ModelAndView demoIframe(HttpServletRequest request) {
		...
		return new ModelAndView("inzy/demo/base/demoIframe");
	}
	...
	public ModelAndView demoList(HttpServletRequest request) {
		return new ModelAndView("inzy/demo/base/demoList");
	}
	...
	public ModelAndView demoCode(TSDemo demo, HttpServletRequest request) {
		...
		demo = list.get(0);
		request.setAttribute("demo", demo);
		return new ModelAndView("inzy/demo/base/democode");
	}
	...
	public ModelAndView uploadTabs(HttpServletRequest request) {
		return new ModelAndView("inzy/demo/base/upload/uploadTabs");
	}
	/**
	 * 图片预览TABS跳转
	 */
	...
	public ModelAndView imgViewTabs(HttpServletRequest request) {
		return new ModelAndView("inzy/demo/base/picview/imgViewTabs");
	}
	/**
	 * 表单验证TABS跳转
	 */
	...
	public ModelAndView formTabs(HttpServletRequest request) {
		return new ModelAndView("inzy/demo/base/formvalid/formTabs");
	}
	/**
	 * 动态模板TABS跳转
	 */
	...
	public ModelAndView templeteTabs(HttpServletRequest request) {
		return new ModelAndView("inzy/demo/base/template/templateiframe");
	}
	/**
	 * 上传演示
	 */
	...
	public ModelAndView autoupload(HttpServletRequest request) {
		...
		return new ModelAndView("inzy/demo/base/"+turn+"");
	}
	...
	public ModelAndView select(HttpServletRequest request) {
		...
		return new ModelAndView("inzy/demo/base/AJAX/select");
	}
	/**
	 *数据字典下拉
	 */
	...
	public ModelAndView dictSelect(HttpServletRequest request) {
		...
		return new ModelAndView("inzy/demo/base/dict/dictSelect");
	}
	/**
	 * 地图demo
	 * @param request
	...
	public ModelAndView mapDemo(HttpServletRequest request) {
		return new ModelAndView("inzy/demo/base/map/mapDemo2");
	}
	/**
	 * 保存DEMO维护
	 * 
