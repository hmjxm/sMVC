...
public class UploadTag extends TagSupport {
	...
	protected String queueSizeLimit="999";//队列中,同时上传的文件个数,默认多个  
	...
	protected String onSelect; // 选择每个文件时触发函数 Add by yun.tang 2015/06/11
	...
	public StringBuffer end() {
		...
		sb.append("<script type=\"text/javascript\">"
				...
				+"progressData:\'speed\'," 
				+"multi:"+multi+","
				+"queueSizeLimit:"+queueSizeLimit+","//队列中,同时上传的文件个数 
				+"height:25,"
		       ...
		       sb.append("} ," 	          
				...
				sb.append("},");
				//========================================//
				// Add by yun.tang 2015/06/11 begin
				if (onSelect != null) {
				    sb.append("onSelect: function(file){");
				    sb.append("  "+ onSelect +"(); ");
 				    sb.append("},");
				}
				// Add by yun.tang 2015/06/11 end
				//========================================//
				//上传成功处理函数
