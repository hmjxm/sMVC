...
import org.inzy.framework.core.util.*;
import org.inzy.framework.tag.vo.easyui.ColumnValue;
import org.inzy.framework.tag.vo.easyui.DataGridColumn;
import org.inzy.framework.tag.vo.easyui.DataGridUrl;
import org.inzy.framework.tag.vo.easyui.OptTypeDirection;
...
public class DataGridTag extends TagSupport {
	...
	private String extendParams;//扩展参数,easyui有的,但是inzy没有的参数进行扩展
	...
	public String getNoAuthOperButton(){
		...
		org.inzy.framework.core.util.LogUtil.info("----getNoAuthOperButton-------"+sb.toString());
		return sb.toString(); 
	}
	...
	private String getAutoSpan(String filed,String extend){
		...
		nsb.append(",parse:function(data){return inzyAutoParse.call(this,data);}");
