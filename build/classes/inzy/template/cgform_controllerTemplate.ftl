...
public class ${entityName}Controller extends BaseController {
	...
	public void datagrid(${entityName}Entity ${entityName?uncap_first},HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		org.inzy.framework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, ${entityName?uncap_first}, request.getParameterMap());
		try{
		//自定义追加查询条件
		<#list columns as po>
	...
	public ModelAndView upload(HttpServletRequest req) {
		return new ModelAndView("${bussiPackage?replace(".","/")}/${entityPackage?replace(".","/")}/${entityName?uncap_first}Upload");
	}
