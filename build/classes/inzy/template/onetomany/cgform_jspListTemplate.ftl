...
<div class="easyui-layout" fit="true">
 ...
 <script src = "webpage/${bussiPackage?replace('.','/')}/${entityPackage?replace(".","/")}/${entityName?uncap_first}List.js"></script>		
...
//导出
function ExportXls() {
	InzyExcelExport("${entityName?uncap_first}Controller.do?exportXls","${entityName?uncap_first}List");
}

//模板下载
function ExportXlsByT() {
	InzyExcelExport("${entityName?uncap_first}Controller.do?exportXlsByT","${entityName?uncap_first}List");
}
 </script>