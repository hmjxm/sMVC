...
<script type="text/javascript" charset="utf-8">
	...
	function courseListExportXls() {
		InzyExcelExport("courseController.do?exportXls","courseList");
	}
	function courseListExportXlsByT() {
		InzyExcelExport("courseController.do?exportXlsByT","courseList");
	}
	function courseListWordXlsByT() {
		InzyExcelExport("courseController.do?exportDocByT","courseList");
	}
	function courseListExportXlsByTe() {
		InzyExcelExport("courseController.do?exportXlsByTest","courseList");
	}
