...
<t:datagrid name="inzyMinidaoList" title="Minidao例子" actionUrl="inzyMinidaoController.do?datagrid" idField="id" fit="true" queryMode="group">
	...
	<t:dgDelOpt title="删除" url="inzyMinidaoController.do?del&id={id}" />
	<t:dgToolBar title="录入" icon="icon-add" url="inzyMinidaoController.do?addorupdate" funname="add"></t:dgToolBar>
	<t:dgToolBar title="编辑" icon="icon-edit" url="inzyMinidaoController.do?addorupdate" funname="update"></t:dgToolBar>
	<t:dgToolBar title="查看" icon="icon-search" url="inzyMinidaoController.do?addorupdate" funname="detail"></t:dgToolBar>
</t:datagrid>
</div>
</div>