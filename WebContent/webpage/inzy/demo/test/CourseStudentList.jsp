...
<script type="text/javascript">
	...
	$('#addCustomBtn').bind('click', function(){   
 		 var tr =  $("#add_inzyStudent_table_template tr").clone();
	 	 $("#add_inzyStudent_table").append(tr);
	 	 resetTrNum('add_inzyStudent_table');
    });  
	$('#delCustomBtn').bind('click', function(){   
      	$("#add_inzyStudent_table").find("input:checked").parent().parent().remove();   
        resetTrNum('add_inzyStudent_table'); 
    }); 
...
<table border="0" cellpadding="2" cellspacing="0" id="inzyOrderCustom_table">
	...
	<tbody id="add_inzyStudent_table">
