...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="inzyDemoController.do?saveAuthor">
	<input id="id" name="id" type="hidden" value="${inzyDemo.id }">
