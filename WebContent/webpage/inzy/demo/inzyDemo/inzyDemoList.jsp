...
<t:datagrid name="inzyDemoList" title="DEMO示例列表" autoLoadData="true" actionUrl="inzyDemoController.do?datagrid" sortName="userName" fitColumns="true"
...
<!--	<t:dgFunOpt exp="status#eq#0" operationCode="szqm" funname="szqm(id)" title="审核" />-->
	<t:dgDelOpt operationCode="del" title="删除" url="inzyDemoController.do?del&id={id}" />
	<t:dgToolBar operationCode="add" title="录入" icon="icon-add" url="inzyDemoController.do?addorupdate" funname="add"></t:dgToolBar>
	<t:dgToolBar operationCode="mobileAdd" title="mobile录入" icon="icon-add" url="inzyDemoController.do?addorupdatemobile" funname="addMobile"></t:dgToolBar>
	<t:dgToolBar operationCode="edit" title="编辑" icon="icon-edit" url="inzyDemoController.do?addorupdate" funname="update"></t:dgToolBar>
	<t:dgToolBar operationCode="edit" title="mobile编辑" icon="icon-edit" url="inzyDemoController.do?addorupdatemobile" funname="updateMobile"></t:dgToolBar>
	<t:dgToolBar operationCode="detail" title="查看" icon="icon-search" url="inzyDemoController.do?addorupdate" funname="detail"></t:dgToolBar>
	<t:dgToolBar operationCode="print" title="打印" icon="icon-print" url="inzyDemoController.do?print" funname="detail"></t:dgToolBar>
	<t:dgToolBar title="批量删除" icon="icon-remove" url="inzyDemoController.do?doDeleteALLSelect" funname="deleteALLSelect"></t:dgToolBar>
...
<script type="text/javascript">
	function szqm(id) {
		createwindow('审核', 'inzyDemoController.do?doCheck&id=' + id);
	}
	function getListSelections(){
		var ids = '';
		var rows = $("#inzyDemoList").datagrid("getSelections");
	...
	function doMigrateIn(){
		openuploadwin('Xml导入', 'transdata.do?toMigrate', "inzyDemoList");
	}
