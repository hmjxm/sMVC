...
<%@page import="org.inzy.framework.web.cgform.common.CgAutoListConstant"%>
		...
		<tr>
			...
			<td class="value" id="jformPkTypeTd" <c:if test="${cgFormHeadPage.jformPkType ne 'SEQUENCE'}">colspan="3"</c:if>>
				<select id="jformPkType" name="jformPkType" onchange="jformPkTypeChange();">
					<option value="DEFAULT" <c:if test="${cgFormHeadPage.jformPkType eq 'DEFAULT'}"> selected='selected'</c:if>><t:mutiLang langKey="common.pk.default"/></option>
