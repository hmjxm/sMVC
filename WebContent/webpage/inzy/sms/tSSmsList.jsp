...
<%--   <t:dgToolBar title="模板下载" icon="icon-putout" funname="ExportXlsByT"></t:dgToolBar>--%>
 ...
 <script src = "webpage/inzy/sms/tSSmsList.js"></script>		
...
//导出
function ExportXls() {
	InzyExcelExport("tSSmsController.do?exportXls","tSSmsList");
}

//模板下载
function ExportXlsByT() {
	InzyExcelExport("tSSmsController.do?exportXlsByT","tSSmsList");
}
 </script>