...
<%--   <t:dgToolBar title="模板下载" icon="icon-putout" funname="ExportXlsByT"></t:dgToolBar>--%>
 ...
 <script src = "webpage/inzy/sms/tSSmsSqlList.js"></script>		
...
//导出
function ExportXls() {
	InzyExcelExport("tSSmsSqlController.do?exportXls","tSSmsSqlList");
}

//模板下载
function ExportXlsByT() {
	InzyExcelExport("tSSmsSqlController.do?exportXlsByT","tSSmsSqlList");
}
 </script>