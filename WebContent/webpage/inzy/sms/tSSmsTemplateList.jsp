...
<%--   <t:dgToolBar title="模板下载" icon="icon-putout" funname="ExportXlsByT"></t:dgToolBar>--%>
 ...
 <script src = "webpage/inzy/sms/tSSmsTemplateList.js"></script>		
...
//导出
function ExportXls() {
	InzyExcelExport("tSSmsTemplateController.do?exportXls","tSSmsTemplateList");
}

//模板下载
function ExportXlsByT() {
	InzyExcelExport("tSSmsTemplateController.do?exportXlsByT","tSSmsTemplateList");
}
 </script>