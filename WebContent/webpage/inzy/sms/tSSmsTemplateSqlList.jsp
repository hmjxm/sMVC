...
<%--   <t:dgToolBar title="模板下载" icon="icon-putout" funname="ExportXlsByT"></t:dgToolBar>--%>
 ...
 <script src = "webpage/inzy/sms/tSSmsTemplateSqlList.js"></script>		
...
//导出
function ExportXls() {
	InzyExcelExport("tSSmsTemplateSqlController.do?exportXls","tSSmsTemplateSqlList");
}

//模板下载
function ExportXlsByT() {
	InzyExcelExport("tSSmsTemplateSqlController.do?exportXlsByT","tSSmsTemplateSqlList");
}
 </script>