...
<div style="height: 100%; margin: 14px 20px 0 20px; overflow-y: auto">
    ...
    <div style="margin-right: 50px;">
        <ul>
            <li>生成代码包的路径(inzy_config.properties)：
                <pre class="code">

  <span class="propTag">bussi_package</span>=<span class="propValue">com.inzyme.p2p</span> // 生成代码的包前缀
                </pre>
            </li>
            <li>代码生成界面的配置：
                <ol>
  ...
  &lt;<span class="propNS">context</span><span class="propTag">:component-scan</span> <span class="propName">base-package=</span><span class="propValue">"com.inzyme.p2p.*"</span>&gt;
  ...
  &lt;<span class="propTag">property</span> <span class="propName">name=</span><span class="propValue">"packagesToScan"</span>&gt;
      &lt;<span class="propTag">list</span>&gt;
          ....
          &lt;!-- 扫描 代码分层 实体 --&gt;
          &lt;<span class="propTag">value</span>&gt;com.inzyme.p2p.entity.*&lt;/<span class="propTag">value</span>&gt;
          &lt;!-- 扫描 业务分层 实体 --&gt;
          &lt;<span class="propTag">value</span>&gt;com.inzyme.p2p.*.entity&lt;/<span class="propTag">value</span>&gt;
      &lt;/<span class="propTag">list</span>&gt;
