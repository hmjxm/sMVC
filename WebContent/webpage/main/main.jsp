...
<SCRIPT type="text/javascript">
	...
	$(function() {
		$('#layout_inzy_onlineDatagrid').datagrid({
			...
			onLoadSuccess : function(data) {
				$('#layout_inzy_onlinePanel').panel('setTitle', '( ' + data.total + ' )' + ' <t:mutiLang langKey="lang.user.online"/>');
			},
		...
		$('#layout_inzy_onlinePanel').panel({
			tools : [ {
				iconCls : 'icon-reload',
				handler : function() {
					$('#layout_inzy_onlineDatagrid').datagrid('load', {});
				}
			} ]
		});
		...
		$(".layout-expand").click(function(){
			...
			$("#layout_inzy_onlinePanel").find(".datagrid-view").css("max-height","200px");
			$("#layout_inzy_onlinePanel .datagrid-view .datagrid-view2 .datagrid-body").css("max-height","180px").css("overflow-y","auto");
		});
	});
	var onlineInterval;
...
<!-- 顶部-->
<div region="north" border="false" title=" INZY Framework 2.0" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
...
<div collapsed="true" region="east" iconCls="icon-reload" title="<t:mutiLang langKey="common.assist.tools"/>" split="true" style="width: 190px;"
    ...
    <div id="layout_inzy_onlinePanel" data-options="fit:true,border:false" title=<t:mutiLang langKey="common.online.user"/>>
        <table id="layout_inzy_onlineDatagrid"></table>
    </div>
</div>
<!-- 底部 -->
<%--<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #CC99FF; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="http://www.inzy.org" title=" INZY Framework 2.0"> INZY Framework 2.0</a>
            <t:mutiLang langKey="common.copyright"/>:
            <a href="#" title=" INZY Framework 2.0">INZY Framework 2.0</a>
        </span>
    </div>
</div>
